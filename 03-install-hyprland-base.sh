...
sudo pacman -S --needed --noconfirm hyprland kitty firefox waybar hyprpolkitagent hyprpaper dunst hyprlauncher nemo xdg-desktop-portal-hyprland wl-copy #rofi-wayland polkit-kde-agent
